        // Cargar los estados desde el servidor al cargar la p�gina
        document.addEventListener('DOMContentLoaded', cargarEstados);

        // Funci�n para cargar los estados en el select
...
async function asignarPaquetes(){
    ...
    try {
        ...
        // Funci�n para enviar los datos del formulario al servidor
async function enviarDatos(accion) {
    ...
    if (estadoConductor === "") {
        alert("Por favor, selecciona un estado v�lido para el conductor.");
        return;
    }
